...
export default function Main() {
  ...
  return <main className="flex flex-col realtive">
    ...
    <div id="home" className='min-h-screen w-screen bg-black      flex flex-col justify-center items-center'>
      ...
      <motion.h1
        ...
        className='duration-200 font-black text-5xl md:text-7xl text-white w-full text-center'>AI for evaluation of <br />descriptive handwritten exam answersheets </motion.h1>
    ...
    <div id="features" className='min-h-screen w-screen bg-black flex flex-col items-center py-20 md:p-20'>
      <h1 className='text-white text-4xl md:text-5xl font-bold mb-20'>Features</h1>
        ...
        {features.map((feature: any, i) => {
          return <div key={i} className='flex group m-5'>
            ...
            <div className='flex flex-col'>
              <p className='text-white text-xl font-semibold'>{feature?.title}</p>
              <p className='text-slate-400 text-lg max-w-sm'>{feature?.subtitle}</p>
            </div>
          </div>
        })}
      </div>
    </div>
    <div id="how-it-works" className='text-white min-h-screen w-screen flex flex-col items-center py-20 md:p-20 bg-black '>
    ...
    <div id="flexible-pricing" className='min-h-screen w-screen flex flex-col items-center py-20 md:p-20 bg-black '>
      <div className='flex flex-col items-center w-full border rounded-2xl p-10 text-white'>
    ...
    <div id="have-a-question" className='min-h-screen w-screen flex flex-col items-center py-20 md:p-20 bg-black text-white '>
    ...
    <div id="get-started" className='text-white w-screen flex flex-col items-center py-20 md:p-20 bg-black '>
    ...
    <div className='text-white w-screen flex flex-col items-center py-20 md:px-32 bg-black'>
      <div className='w-full flex flex-col md:flex-row items-center justify-between'>
        ...
        <div className='mt-10 md:mt-0 flex flex-col md:flex-row items-center'>
          <Link className='flex items-center my-2 md:ml-10' href="https://instagram.com/papercheckai"><FiInstagram className='mr-2' /> </Link>
          <Link className='flex items-center my-2 md:ml-10' href="https://x.com/papercheckai"><FiX className='mr-2' /> </Link>
          <Link className='flex items-center my-2 md:ml-10' href="https://facebook.com/papercheckai"><FiFacebook className='mr-2' /> </Link>
